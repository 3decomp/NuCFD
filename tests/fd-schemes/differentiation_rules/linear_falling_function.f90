! tests/fd-schemes/differentiation_rules/linear_falling_function.f90
!
!! Part of the fd-schemes test suite.
!
! SPDX-License-Identifier: BSD-3-Clause

program linear_falling_function
  !! Tests that rules of differentiation are respected for linearly decreasing functions.
...
end program linear_falling_function
